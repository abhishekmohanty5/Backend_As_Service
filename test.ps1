...
$loginBody = @{ email = "admin@example.com"; password = "your_password_here" } | ConvertTo-Json -Compress
...
$tenantLoginBody = @{ email = "admin@example.com"; password = "your_password_here" } | ConvertTo-Json -Compress
