package com.jobhunt.saas.ai.application.service.impl;
...
import com.jobhunt.saas.ai.domain.port.in.AiUseCase;
...
@Service
@Slf4j
public class AiServiceImpl implements AiService, AiUseCase {
